...
const HemartSetting = require('../abstract/HemartSetting.js');
...
class SettingsManager {
    ...
    async createDefaults(guildID, prefix) {
        const statement = await this.db.prepare('INSERT INTO Settings VALUES(?, ?)', [guildID, prefix]);
        await statement.run();
    ...
    async get(guildID, createIfNotExist = false) {
        ...
        return new HemartSetting(statement, this.db);
    }
